      ...
      {isDeleting && (
        <Modal onClose={handleStopDeleting}>
          ...
          <div className='form-actions'>
            {isPendingDeletion && <p>Please, wait...</p>}
            {!isPendingDeletion && (
              <>
          ...
          {isErrorDeleting && <ErrorBlock title='Failed deleting event' message={deleteError.info?.message || 'Failed to delete event, please try again.'} />}
        </Modal>
      )}
